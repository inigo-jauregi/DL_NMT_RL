...
class ONMTDatasetBase(torchtext.data.Dataset):
    ...
    def _construct_example_fromlist(self, data, fields):
        ...
        #Creates a class with attributes ex.src, ex.indices and ex.tgt
        for (name, field), val in zip(fields, data): #Iterate each field, and pre-process according to the field
