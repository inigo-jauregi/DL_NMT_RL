...
class Trainer(object):
	...
	def train(self, train_iter, epoch, report_func=None, train_part='all', model_opt=None, fields=None):
		""" Train next epoch.
		Args:
	...
	def REINFORCE_train(self, train_iter, epoch, report_func=None, train_part='all', data=None):
		""" Train next epoch.
		Args:
			train_iter: training data iterator
			epoch(int): the epoch number
