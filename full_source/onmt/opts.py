...
def model_opts(parser):
	...
	group.add_argument('-position_encoding', action='store_true',
					   ...
					   """)
	# Global context
	group.add_argument('-context_type', type=str, default=None,
					   help='Where to consider context: [HAN_enc|HAN_dec|HAN_dec_source|HAN_dec_context|HAN_join]')
	group.add_argument('-context_size', type=int, default=3,
...
def preprocess_opts(parser):
	...
	group.add_argument('-train_doc', required=True,
					   help="Path to the training document")
	group.add_argument('-valid_tgt', required=True,
					   help="Path to the validation target data")
	group.add_argument('-valid_doc', required=True,
	...
	group.add_argument('-src_seq_length_trunc', type=int, default=50,
					   help="Truncate source sequence length.")
	group.add_argument('-tgt_seq_length', type=int, default=50,
					   help="Maximum target sequence length to keep.")
	group.add_argument('-tgt_seq_length_trunc', type=int, default=50,
...
def train_opts(parser):
	...
	group.add_argument('-train_part', default='all', type=str,
...
def translate_opts(parser):
	...
	group.add_argument('-src',   required=True,
					   ...
					   sequence)""")
	group.add_argument('-doc',   required=True,
					   help="""Source sequence to decode (one line per
					   sequence)""")
	group.add_argument('-src_dir',   default="",
					   help='Source directory for image or audio files')
	...
	group.add_argument('-translate_part', default='all', type=str,
					   help="[all|sentences|context]")
