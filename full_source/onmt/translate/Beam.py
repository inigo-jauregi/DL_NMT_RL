...
class Beam(object):
    ...
    def __init__(self, size, pad, bos, eos,
        ...
        # The decoders output probability over tgt vocabulary at each time-step.
        self.next_out_prob = []
    ...
    def advance(self, word_probs, attn_out, out_prob=None):
        """
        ...
        * `attn_out`- attention at the last step
        ...
        self.scores = best_scores #.detach() not tried yet
        ...
        # add a list to save the hidden vectors
        self.next_out_prob.append(out_prob)
    ...
    def get_hyp(self, timestep, k):
        ...
        for j in range(len(self.prev_ks[:timestep]) - 1, -1, -1):
            hyp.append(self.next_ys[j+1][k])#.detach().cpu().numpy())
            attn.append(self.attn[j][k])#.detach().cpu())
